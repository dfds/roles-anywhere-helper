...
func ImportCertificate(profileName string, acmpcaArn string, commonName string, organizationName []string, organizationalUnit []string, certificateDirectory string) {
